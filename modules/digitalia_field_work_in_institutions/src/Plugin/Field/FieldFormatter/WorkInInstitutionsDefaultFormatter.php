...
namespace Drupal\digitalia_field_work_in_institutions\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'digitalia_field_work_in_institutions_default' formatter.
 *
 * @FieldFormatter(
 *   id = "digitalia_field_work_in_institutions_default",
 *   label = @Translation("Default"),
 *   field_types = {"digitalia_field_work_in_institutions"},
 * )
 */
final class WorkInInstitutionsDefaultFormatter extends FormatterBase {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode): array {
    ...
    foreach ($items as $delta => $item) {
      ...
      if ($item->from_day) {
        $allowed_values = WorkInInstitutionsItem::allowedFromDayValues();
      ...
      if ($item->from_month) {
        $allowed_values = WorkInInstitutionsItem::allowedFromMonthValues();
      ...
      if ($item->to_day) {
        $allowed_values = WorkInInstitutionsItem::allowedToDayValues();
      ...
      if ($item->to_month) {
        $allowed_values = WorkInInstitutionsItem::allowedToMonthValues();
