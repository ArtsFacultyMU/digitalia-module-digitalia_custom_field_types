...
namespace Drupal\digitalia_field_studies\Plugin\Field\FieldType;
...
/**
 * Defines the 'digitalia_field_studies' field type.
 *
 * @FieldType(
 *   id = "digitalia_field_studies",
 *   label = @Translation("Studies"),
 *   description = @Translation("Some description."),
 *   default_widget = "digitalia_field_studies",
 *   default_formatter = "digitalia_field_studies_default",
 * )
 */
final class StudiesItem extends FieldItemBase {

  /**
   * {@inheritdoc}
   */
  public function isEmpty(): bool {
    return $this->institution === NULL && $this->from_day === NULL && $this->from_month === NULL && $this->from_year === NULL && $this->to_day === NULL && $this->to_month === NULL && $this->to_year === NULL && $this->specialization === NULL;
  }
  ...
  public static function propertyDefinitions(FieldStorageDefinitionInterface $field_definition): array {
    ...
    $properties['to_year'] = DataDefinition::create('integer')
      ->setLabel(t('To (year)'));
    $properties['specialization'] = DataDefinition::create('string')
  ...
  public function getConstraints(): array {
    ...
    $options['from_day']['AllowedValues'] = array_keys(StudiesItem::allowedFromDayValues());

    $options['from_month']['AllowedValues'] = array_keys(StudiesItem::allowedFromMonthValues());

    $options['to_day']['AllowedValues'] = array_keys(StudiesItem::allowedToDayValues());

    $options['to_month']['AllowedValues'] = array_keys(StudiesItem::allowedToMonthValues());
  ...
  public static function generateSampleValue(FieldDefinitionInterface $field_definition): array {
    ...
    $values['specialization'] = $random->word(mt_rand(1, 255));
